...
class BioTrainer:
    ...
    def _tokenizer_datasets(self):
        ...
        def tokenize_function(examples):
            return self.tokenizer(
                examples["sequence"], truncation=True, max_length=self.args.max_length
            )
    ...
    def setup_model(self):
        ...
        model = EsmForSequenceClassification.from_pretrained(
            self.args.model_name, num_labels=2, cache_dir=self.args.cache_dir  # 二分类
        )
...
def parse_args():
    ...
    parser.add_argument(
        "--output_dir", type=str, default="./results/model", help="Output directory"
    )
